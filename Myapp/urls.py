...
urlpatterns = [
    ...
    path('talep/<int:request_id>/emanet/fonla/', views.fund_escrow, name='fund_escrow'),
    path('talep/<int:request_id>/emanet/serbest-birak/', views.release_escrow, name='release_escrow'),
